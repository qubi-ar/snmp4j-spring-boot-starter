...
public class MockNetworkPollingJob implements PollingJob {
  ...
  public void execute(JobContext ctx) throws Exception {
    ...
    TargetSpec router1 = new TargetSpec("127.0.0.1", 1611, "public", "public", null);
    var router1Result = client.get(router1, "1.3.6.1.2.1.1.1.0", "1.3.6.1.2.1.1.3.0");
    ...
    TargetSpec coreSwitch = new TargetSpec("127.0.0.1", 1612, "monitor", "monitor", null);
    var switchResult = client.get(coreSwitch, "1.3.6.1.2.1.1.1.0", "1.3.6.1.2.1.1.3.0");
